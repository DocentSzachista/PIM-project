...
class _DetailsWidgetState extends State<DetailsWidget> {
  ...
  Widget _editRow(BuildContext context, String rowText, TextEditingController controller) => Row(
  ...
  Future _openTagsDialog(
      ...
      {bool multilineInput = false}) => showDialog(context: context,
      builder: (context) => AlertDialog(
        ...
        actions: [
          TextButton(onPressed: () {onClickAction();}, child: Text("Submit"))
        ],
      ));
    ...
    return Padding(
        ...
        child:SingleChildScrollView(child: Center( child: Column(
          children: [
            ...
            _editRow(
                context,
                AppLocalizations.of(context)!.tagTitle,
                controllerTagsText
            ),
            Wrap(
                children: List.generate(widget.document.tags.length, (index) => Chip(
                    label: Text(widget.document.tags[index]))
                ).toList()
            ),
